...
import { LayoutDashboard, BookOpen, Layers, GraduationCap, LogOut, HelpCircle, Search, Bell, Settings } from "lucide-react";
      ...
      <header className="fixed top-0 w-full bg-surface/80 backdrop-blur-xl z-50 border-b border-outline-variant/10">
        <div className="max-w-7xl mx-auto px-6 py-3 flex items-center justify-between">
          <div className="flex items-center gap-8">
            <span className="text-xl font-bold text-blue-800 font-headline tracking-tight">Lexis Sanctuary</span>
          </div>
          <div className="flex items-center gap-4">
            ...
            <button className="p-2 hover:bg-surface-container-high rounded-full"><Settings className="w-5 h-5" /></button>
